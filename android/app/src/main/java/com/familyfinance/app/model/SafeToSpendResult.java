...
public final class SafeToSpendResult {
    ...
    public static SafeToSpendResult fromJson(JSONObject json) {
        return new SafeToSpendResult(
                ...
                JsonMoney.cents(json, "category_remaining_before_cents"),
                JsonMoney.cents(json, "category_remaining_after_cents"),
                JsonMoney.cents(json, "cash_after_bills_before_purchase_cents"),
                JsonMoney.cents(json, "cash_after_purchase_and_bills_cents"),
